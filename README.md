# Notepad-App
An android app for taking notes developed in Android Studio in Java. The App was tested on a physical device and a virtual device. 
...
<img src="https://github.com/EllenWhelan/Notepad-App/blob/main/images/menu.jpg" width="40%">
A user selects the menu (the three dots)to add a note or selects a note to edit it.


<img src="https://github.com/EllenWhelan/Notepad-App/blob/main/images/edit.jpg" width="40%">
They are then taken to the editing page for the selected note or new note.

<img src="https://github.com/EllenWhelan/Notepad-App/blob/main/images/delete.jpg" width="40%">
